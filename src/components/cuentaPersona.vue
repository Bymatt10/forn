<template>
    <v-card class="mx-auto" max-width="700" outlined id="margen">
        <center>
            <h3 id="margen">Formulario de registro personas</h3>
        </center>
        <v-form v-model="valid">
            <v-container>
                <v-row no-gutters justify="center" id="margen">
                    ...
                    <v-col md="5">
                        ...
                        <v-menu ref="menu" v-model="menu" :close-on-content-click="false" :return-value.sync="date"
                            ...
                            <template v-slot:activator="{ on, attrs }">
                                <v-text-field style="margin-right: 15px;" v-model="natural.fechaNacimiento"
                                    :rules="Rules" required prepend-icon="mdi-calendar" readonly v-bind="attrs"
                                    v-on="on"></v-text-field>
                            </template>
                            <v-date-picker v-model="natural.fechaNacimiento" no-title scrollable>
                                <v-spacer></v-spacer>
                    ...
                    <v-col md="5">
                        <label>Genero</label>
                        <v-select v-model="natural.genero" :items="genero" item-text="genero" item-value="genero"
                    ...
                    <v-col md="5">
                        ...
                        <v-select style="margin-right: 15px;" v-model="natural.tipoIdentificacion" :items="tipoIdent"
                            item-text="tipo" item-value="tipo" :rules="Rules" required></v-select>
                    </v-col>
                    ...
                    <v-col md="5">
                        <label>Correo</label>
                        <v-text-field :rules="emailRules" v-model="natural.correo" required></v-text-field>
                    </v-col>
